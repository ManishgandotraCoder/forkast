    ...
    return (
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className={`p-4 rounded-lg text-white ${portfolioStats.totalChange >= 0 ? 'bg-gradient-to-r from-green-500 to-green-600' : 'bg-gradient-to-r from-red-500 to-red-600'}`}>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm opacity-90">
                                {formatChange(portfolioStats.totalChangePercent, true)}
                            </p>
                        </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-lg text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-purple-100 text-sm">Assets</p>
                            <p className="text-2xl font-bold">{portfolioStats.assetCount}</p>
                        </div>
